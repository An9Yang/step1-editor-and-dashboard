function Component_1_1() {
  return (
    ...
    >
      ...
      >
        <div className="text-center relative caret-[#5f5f5d] [color-scheme:light]"></div>
      </button>
      <div
        type="button"
        id="radix-_r_3i_"
        className="w-10 h-10 flex justify-center items-center caret-[#1c1c1c] [color-scheme:light] rounded-br-[8px] rounded-t-[8px] rounded-bl-[8px] group"
      >
