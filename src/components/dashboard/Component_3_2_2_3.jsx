...
import Component_3_2_2_3_1 from './Component_3_2_2_3_1';

function Component_3_2_2_3() {
  return (
    <div
      className="w-full max-w-[420px] caret-[#1c1c1c] [color-scheme:light]"
      data-component-id="Component_3_2_2_3"
    >
      <div className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] group">
        <div className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] mb-3">
          <Link
            to="/projects/74e1d6bd-aa9e-48dc-a7dc-be294341a608"
          ...
          >
            <div className="w-full h-full relative caret-[#1c1c1c] [color-scheme:light]">
              <img
                alt="Screenshot of Pixel Perfect Replicate"
                loading="lazy"
                src="https://lovable.dev/_next/image?url=https%3A%2F%2Fscreenshot2.lovable.dev%2F33d6308f-0581-4685-b620-65051264a132%2Fid-preview-9b3bb091--74e1d6bd-aa9e-48dc-a7dc-be294341a608.lovable.app-1765890535830.png&w=3840&q=75"
...
export default Component_3_2_2_3;
