...
import Component_3_2_2_12_1 from './Component_3_2_2_12_1';

function Component_3_2_2_12() {
  return (
    <div
      className="w-full max-w-[420px] caret-[#1c1c1c] [color-scheme:light]"
      data-component-id="Component_3_2_2_12"
    >
      <div className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] group">
        <div className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] mb-3">
          <Link
            to="/projects/b56c9bd1-6228-4f11-b6b9-6962d7d9eb94"
          ...
          >
            <div className="w-full h-full relative caret-[#1c1c1c] [color-scheme:light]">
              <img
                alt="Screenshot of vision-layout-reboot"
                loading="lazy"
                src="https://lovable.dev/_next/image?url=https%3A%2F%2Fscreenshot2.lovable.dev%2F648d7afd-8cac-4e0a-8659-89454f4b10d2%2Fid-preview-37023057--b56c9bd1-6228-4f11-b6b9-6962d7d9eb94.lovable.app-1759846866579.png&w=3840&q=75"
        ...
        <Component_3_2_2_12_1 />
      </div>
    </div>
  );
}

export default Component_3_2_2_12;
