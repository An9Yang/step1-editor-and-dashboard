...
function ProjectCard11Details() {
  return (
    <div
      className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] mb-3"
      data-component-id="Component_3_2_2_11_1"
    >
      <Link
        to="/projects/b30da335-2fcb-43be-9f3b-51d436fa07b1"
      ...
      >
        <div className="w-full h-full relative caret-[#1c1c1c] [color-scheme:light]">
          <img
            alt="Screenshot of visual-harmony-deck"
            loading="lazy"
            src="https://lovable.dev/_next/image?url=https%3A%2F%2Fscreenshot2.lovable.dev%2Fa421c30d-1e34-4db6-b77a-f285199dd12c%2Fid-preview-d05111df--b30da335-2fcb-43be-9f3b-51d436fa07b1.lovable.app-1759848434235.png&w=3840&q=75"
      ...
      <div className="absolute caret-[#1c1c1c] [color-scheme:light] pointer-events-none p-2 left-0 right-auto top-auto bottom-0">
        <a
          href="https://visual-harmony-deck.lovable.app"
          className="opacity-50 caret-[#1c1c1c] [color-scheme:light]"
        >
          <span className="bg-[#f7f4ed] font-[480] text-[12px] text-center inline-flex items-center caret-[#1c1c1c] [color-scheme:light] px-1.5 py-0.5 rounded-br-[4px] rounded-t-[4px] rounded-bl-[4px]">
            Published
          </span>
        </a>
      </div>
...
export default ProjectCard11Details;
