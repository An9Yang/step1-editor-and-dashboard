...
import Component_3_2_2_13_1 from './Component_3_2_2_13_1';

function Component_3_2_2_13() {
  return (
    <div
      className="w-full max-w-[420px] caret-[#1c1c1c] [color-scheme:light]"
      data-component-id="Component_3_2_2_13"
    >
      <div className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] group">
        <div className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] mb-3">
          <Link
            to="/projects/65221574-955b-4a14-81c8-802989ecd164"
          ...
          >
            <div className="w-full h-full relative caret-[#1c1c1c] [color-scheme:light]">
              <img
                alt="Screenshot of parallax-puzzle-play"
                loading="lazy"
                src="https://lovable.dev/_next/image?url=https%3A%2F%2Fscreenshot2.lovable.dev%2F78dbd700-7c95-4cc3-8ddb-1619d07ed76e%2Fid-preview-9a5e5c7e--65221574-955b-4a14-81c8-802989ecd164.lovable.app-1756516483330.png&w=3840&q=75"
        ...
        <Component_3_2_2_13_1 />
      </div>
    </div>
  );
}

export default Component_3_2_2_13;
