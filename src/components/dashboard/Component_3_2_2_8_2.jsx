import Component_3_2_2_8_2_1 from './Component_3_2_2_8_2_1';

function Component_3_2_2_8_2() {
  return (
    <div
      className="flex items-center gap-y-2 gap-x-2 caret-[#1c1c1c] [color-scheme:light]"
      data-component-id="Component_3_2_2_8_2"
    >
      <a
      ...
      <Component_3_2_2_8_2_1 />
    </div>
  );
}

export default Component_3_2_2_8_2;
