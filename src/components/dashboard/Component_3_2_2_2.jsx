...
import Component_3_2_2_2_1 from './Component_3_2_2_2_1';

function Component_3_2_2_2() {
  return (
    <div
      className="w-full max-w-[420px] caret-[#1c1c1c] [color-scheme:light]"
      data-component-id="Component_3_2_2_2"
    >
      <div className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] group">
        <div className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] mb-3">
          <Link
            to="/projects/ce90d0d6-b5f1-4132-b8e8-2c7831703776"
          ...
          >
            <div className="w-full h-full relative caret-[#1c1c1c] [color-scheme:light]">
              <img
                alt="Screenshot of Pixel Perfect Pages"
                loading="lazy"
                src="https://lovable.dev/_next/image?url=https%3A%2F%2Fscreenshot2.lovable.dev%2Fd6aa0bf4-9272-4315-b202-13770fbe8a35%2Fid-preview-c9bb0963--ce90d0d6-b5f1-4132-b8e8-2c7831703776.lovable.app-1765892307540.png&w=3840&q=75"
...
export default Component_3_2_2_2;
