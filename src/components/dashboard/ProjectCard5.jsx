...
import ProjectCard5Details from './ProjectCard5Details';

function ProjectCard5() {
  return (
    <div
      className="w-full max-w-[420px] caret-[#1c1c1c] [color-scheme:light]"
      data-component-id="Component_3_2_2_5"
    >
      <div className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] group">
        <div className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] mb-3">
          <Link
            to="/projects/7e6b16de-6164-42ac-96fa-a409b8257c1b"
          ...
          >
            <div className="w-full h-full relative caret-[#1c1c1c] [color-scheme:light]">
              <img
                alt="Screenshot of Allbirds Reimagined"
                loading="lazy"
                src="https://lovable.dev/_next/image?url=https%3A%2F%2Fscreenshot2.lovable.dev%2F970cbe47-cc4e-46f0-8775-f47bc0ea7db6%2Fid-preview-a0fdbf0b--7e6b16de-6164-42ac-96fa-a409b8257c1b.lovable.app-1765779359030.png&w=3840&q=75"
