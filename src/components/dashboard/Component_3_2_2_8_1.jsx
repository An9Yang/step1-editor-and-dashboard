...
function Component_3_2_2_8_1() {
  return (
    <div
      className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] mb-3"
      data-component-id="Component_3_2_2_8_1"
    >
      <Link
        to="/projects/72b989ba-5180-45d0-b832-a70601eb91a2"
      ...
      >
        <div className="w-full h-full relative caret-[#1c1c1c] [color-scheme:light]">
          <img
            alt="Screenshot of sql-verse-ai-wizard"
            loading="lazy"
            src="https://lovable.dev/_next/image?url=https%3A%2F%2Fscreenshot2.lovable.dev%2Fc242a607-afe1-403c-bc3c-41d0c401ce6c%2Fid-preview-a9b2cffc--72b989ba-5180-45d0-b832-a70601eb91a2.lovable.app-1752410946535.png&w=3840&q=75"
      ...
      <div className="absolute caret-[#1c1c1c] [color-scheme:light] pointer-events-none p-2 left-0 right-auto top-auto bottom-0">
        <a
          href="https://sql-verse-ai-wizard.lovable.app"
...
export default Component_3_2_2_8_1;
