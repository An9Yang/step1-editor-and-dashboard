...
function Component_3_2_2_9_1() {
  return (
    <div
      className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] mb-3"
      data-component-id="Component_3_2_2_9_1"
    >
      <Link
        to="/projects/585c887a-768b-4f01-abf1-39684b03cdcd"
      ...
      >
        <div className="w-full h-full relative caret-[#1c1c1c] [color-scheme:light]">
          <img
            alt="Screenshot of design-learn-me"
            loading="lazy"
            src="https://lovable.dev/_next/image?url=https%3A%2F%2Fscreenshot2.lovable.dev%2Fffa34676-3d0f-493e-ad4b-f81cac213d59%2Fid-preview-4f467657--585c887a-768b-4f01-abf1-39684b03cdcd.lovable.app-1759852251793.png&w=3840&q=75"
      ...
      <div className="absolute caret-[#1c1c1c] [color-scheme:light] pointer-events-none p-2 left-0 right-auto top-auto bottom-0">
        <a
          href="https://design-learn-me.lovable.app"
...
export default Component_3_2_2_9_1;
