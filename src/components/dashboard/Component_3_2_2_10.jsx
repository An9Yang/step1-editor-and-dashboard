...
import Component_3_2_2_10_1 from './Component_3_2_2_10_1';

function Component_3_2_2_10() {
  return (
    <div
      className="w-full max-w-[420px] caret-[#1c1c1c] [color-scheme:light]"
      data-component-id="Component_3_2_2_10"
    >
      <div className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] group">
        <div className="relative flex flex-col caret-[#1c1c1c] [color-scheme:light] mb-3">
          <Link
            to="/projects/3ab07dea-7cb3-4b56-b3f6-a84eb6daa096"
          ...
          >
            <div className="w-full h-full relative caret-[#1c1c1c] [color-scheme:light]">
              <div className="bg-[#fcfbf8] absolute flex justify-center items-center caret-[#1c1c1c] [color-scheme:light] rounded-br-[12px] rounded-t-[12px] rounded-bl-[12px] border-[#eceae4] inset-0 border">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="rgb(236, 234, 228)"
                  viewBox="0 0 12 13"
                  className="text-[#eceae4] align-middle w-8 h-8 block overflow-x-hidden overflow-y-hidden opacity-50 fill-[#eceae4] caret-[#eceae4] [color-scheme:light]"
                  data-svg-size="544"
                >
                  <path
                    fill="rgb(236, 234, 228)"
                    ...
                    clipRule="evenodd"
                    className="inline fill-[#eceae4] [fill-rule:evenodd] caret-[#eceae4] [color-scheme:light]"
                  ></path>
                </svg>
              </div>
              <div
        ...
        <Component_3_2_2_10_1 />
      </div>
    </div>
  );
}

export default Component_3_2_2_10;
