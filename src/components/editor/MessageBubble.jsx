function MessageBubble() {
  return (
    <div
      className="text-[#5f5f5d] w-full flex flex-col items-end caret-[#5f5f5d] [color-scheme:light] mb-2"
    ...
    >
      ...
      <div className="flex items-center flex-row-reverse gap-y-1.5 gap-x-1.5 caret-[#5f5f5d] [color-scheme:light] mr-2 mt-1">
        <span className="text-[10px] w-5 h-5 relative flex overflow-x-hidden overflow-y-hidden shrink-0 items-center caret-[#5f5f5d] [color-scheme:light] rounded-full border-[rgba(0,0,0,0)] border">
          <img
