                ...
                <div className="relative">
                  ...
                  {settingsOpen && (
                    <div className="absolute top-full left-0 mt-1.5 w-56 bg-[#fcfbf8] rounded-[8px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] border border-[#eceae4] z-50 overflow-hidden">
                      {/* Tab Headers */}
                      <div className="flex bg-[#f7f4ed]">
                        <button
                          onClick={() => setSettingsTab('project')}
                          className={`flex-1 px-4 py-2 text-[13px] font-[480] transition-colors relative ${settingsTab === 'project' ? 'text-[#1c1c1c] bg-[#fcfbf8]' : 'text-[#5f5f5d] hover:text-[#1c1c1c]'}`}
                        >
                          Project
                        </button>
                        <button
                          onClick={() => setSettingsTab('personal')}
                          className={`flex-1 px-4 py-2 text-[13px] font-[480] transition-colors relative ${settingsTab === 'personal' ? 'text-[#1c1c1c] bg-[#fcfbf8]' : 'text-[#5f5f5d] hover:text-[#1c1c1c]'}`}
                        >
                          Personal
                        </button>
                      </div>
                      ...
                      <div className="p-1.5">
                        {settingsTab === 'project' ? (
                          <div className="space-y-0.5">
                            ...
                            <div className="border-t border-[#eceae4] my-1.5 mx-1"></div>
