            ...
            <div className="[text-wrap-mode:nowrap] w-[30%] flex shrink-0 items-center gap-y-2 gap-x-2 caret-[#1c1c1c] [color-scheme:light]">
              ...
              <div className="[text-wrap-mode:nowrap] flex gap-x-1 caret-[#1c1c1c] [color-scheme:light] ml-auto mr-2">
                ...
                >
                  ...
                  >
                    <path d="M9 3.25A2.75 2.75 0 0 1 11.75 6v3A2.75 2.75 0 0 1 9 11.75H6A2.75 2.75 0 0 1 3.25 9V6A2.75 2.75 0 0 1 6 3.25h3Zm0 1.5H6c-.69 0-1.25.56-1.25 1.25v3c0 .69.56 1.25 1.25 1.25h3c.69 0 1.25-.56 1.25-1.25V6c0-.69-.56-1.25-1.25-1.25ZM18 3.25A2.75 2.75 0 0 1 20.75 6v3A2.75 2.75 0 0 1 18 11.75h-3A2.75 2.75 0 0 1 12.25 9V6A2.75 2.75 0 0 1 15 3.25h3Zm0 1.5h-3c-.69 0-1.25.56-1.25 1.25v3c0 .69.56 1.25 1.25 1.25h3c.69 0 1.25-.56 1.25-1.25V6c0-.69-.56-1.25-1.25-1.25ZM9 12.25A2.75 2.75 0 0 1 11.75 15v3A2.75 2.75 0 0 1 9 20.75H6A2.75 2.75 0 0 1 3.25 18v-3A2.75 2.75 0 0 1 6 12.25h3Zm0 1.5H6c-.69 0-1.25.56-1.25 1.25v3c0 .69.56 1.25 1.25 1.25h3c.69 0 1.25-.56 1.25-1.25v-3c0-.69-.56-1.25-1.25-1.25ZM18 12.25A2.75 2.75 0 0 1 20.75 15v3A2.75 2.75 0 0 1 18 20.75h-3A2.75 2.75 0 0 1 12.25 18v-3A2.75 2.75 0 0 1 15 12.25h3Zm0 1.5h-3c-.69 0-1.25.56-1.25 1.25v3c0 .69.56 1.25 1.25 1.25h3c.69 0 1.25-.56 1.25-1.25v-3c0-.69-.56-1.25-1.25-1.25Z" />
                  </svg>
                </button>
