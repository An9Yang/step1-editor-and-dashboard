  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="min-h-[auto] w-full max-w-screen-md flex flex-col items-start caret-[#1c1c1c] [color-scheme:light] mx-auto pb-2 group"
      >
        {/* AI Avatar and Name */}
        ...
        <div className="max-w-[85%] caret-[#1c1c1c] [color-scheme:light]">
          <div className="relative caret-[#1c1c1c] [color-scheme:light]">
            <div className="[overflow-wrap:anywhere] leading-[22px] text-left flex flex-col caret-[#1c1c1c] [color-scheme:light] px-4">
